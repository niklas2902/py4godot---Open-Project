...
from py4godot.classes.generated4_core import NodePath, Vector3, Vector2, Array
from py4godot.pluginscript_api.utils.annotations import gdclass

from Scripts.Tools.Draw import Draw
from py4godot.pluginscript_api.utils.annotations import prop, gdproperty, gdmethod
            ...
            if vector.get_y() != 0:
                ...
                res = self._util.callv("box_cast",
                                       Array(origin + Vector3(0, 0, vector.get_y()),
                                             SIZE, 0.02, 0.02, Array(self),
                                             self.collision_layer_direction)).get_converted_value()
                self.draw_sphere("push", 1, self.global_transform.get_origin() +
